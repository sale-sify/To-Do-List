...
//  Variables réactives pour la gestion de la première visite
    const username = ref<string | null>(null);
    const isFirstVisit = ref(true);
    const storedUsername = localStorage.getItem('username');

// Vérification de la présence d'un nom d'utilisateur dans le localStorage
    if (storedUsername) {
        username.value = storedUsername;
        isFirstVisit.value = false;
    }

// Gestion de la soumission du formulaire de première visite
...
// Gestion de l'affichage du formulaire de nouvelle tâche
